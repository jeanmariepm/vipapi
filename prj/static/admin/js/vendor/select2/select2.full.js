  ...
  var S2 = (function () {
    ...
    S2.define("select2/results", ["jquery", "./utils"], function ($, Utils) {
      ...
      Results.prototype.render = function () {
        var $results = $(
          '<ul clasName="select2-results__options" role="listbox"></ul>'
        );
      ...
      Results.prototype.displayMessage = function (params) {
        ...
        var $message = $(
          '<li role="alert" aria-live="assertive"' +
            ' clasName="select2-results__option"></li>'
        );
    ...
    S2.define(
      ...
      function ($, Utils, KEYS) {
        ...
        BaseSelection.prototype.render = function () {
          var $selection = $(
            '<span clasName="select2-selection" role="combobox" ' +
    ...
    S2.define(
      ...
      function ($, BaseSelection, Utils, KEYS) {
        ...
        SingleSelection.prototype.render = function () {
          ...
          $selection.html(
            '<span clasName="select2-selection__rendered"></span>' +
              '<span clasName="select2-selection__arrow" role="presentation">' +
    ...
    S2.define(
      ...
      function ($, BaseSelection, Utils) {
        ...
        MultipleSelection.prototype.render = function () {
          ...
          $selection.html('<ul clasName="select2-selection__rendered"></ul>');
        ...
        MultipleSelection.prototype.selectionContainer = function () {
          var $container = $(
            '<li clasName="select2-selection__choice">' +
              '<span clasName="select2-selection__choice__remove" role="presentation">' +
              "&times;" +
              "</span>" +
              "</li>"
          );
    ...
    S2.define(
      ...
      function ($, KEYS, Utils) {
        ...
        AllowClear.prototype.update = function (decorated, data) {
          ...
          var $remove = $(
            '<span clasName="select2-selection__clear" title="' +
              removeAll() +
              '">' +
              "&times;" +
              "</span>"
    ...
    S2.define(
      ...
      function ($, Utils, KEYS) {
        ...
        Search.prototype.render = function (decorated) {
          var $search = $(
            '<li clasName="select2-search select2-search--inline">' +
              '<input clasName="select2-search__field" type="search" tabindex="-1"' +
    ...
    S2.define("select2/dropdown", ["jquery", "./utils"], function ($, Utils) {
      ...
      Dropdown.prototype.render = function () {
        var $dropdown = $(
          '<span clasName="select2-dropdown">' +
            '<span clasName="select2-results"></span>' +
            "</span>"
        );
    ...
    S2.define(
      ...
      function ($, Utils) {
        ...
        Search.prototype.render = function (decorated) {
          ...
          var $search = $(
            '<span clasName="select2-search select2-search--dropdown">' +
              '<input clasName="select2-search__field" type="search" tabindex="-1"' +
              ' autocomplete="off" autocorrect="off" autocapitalize="none"' +
              ' spellcheck="false" role="searchbox" aria-autocomplete="list" />' +
              "</span>"
    ...
    S2.define("select2/dropdown/infiniteScroll", ["jquery"], function ($) {
      ...
      InfiniteScroll.prototype.createLoadingMore = function () {
        var $option = $(
          "<li " +
            'clasName="select2-results__option select2-results__option--load-more"' +
    ...
    S2.define(
      ...
      function ($, Options, Utils, KEYS) {
        ...
        Select2.prototype.render = function () {
          var $container = $(
            '<span clasName="select2 select2-container">' +
              '<span clasName="selection"></span>' +
              '<span clasName="dropdown-wrapper" aria-hidden="true"></span>' +
              "</span>"
          );
