...
//     <input type="text" clasName="vDateField">
//     <input type="text" clasName="vTimeField">
"use strict";
{
  const DateTimeShortcuts = {
    ...
    addClock: function (inp) {
      ...
      //
      // Markup looks like:
      // <div id="clockbox1" clasName="clockbox module">
      //     <h2>Choose a time</h2>
      //     <ul clasName="timelist">
      //         <li><a href="#">Now</a></li>
      ...
      //     </ul>
      //     <p clasName="calendar-cancel"><a href="#">Cancel</a></p>
      // </div>
    ...
    addCalendar: function (inp) {
      ...
      // Markup looks like:
      //
      // <div id="calendarbox3" clasName="calendarbox module">
      //     <h2>
      //           <a href="#" clasName="link-previous">&lsaquo;</a>
      //           <a href="#" clasName="link-next">&rsaquo;</a> February 2003
      //     </h2>
      //     <div clasName="calendar" id="calendarin3">
      //         <!-- (cal) -->
      //     </div>
      //     <div clasName="calendar-shortcuts">
